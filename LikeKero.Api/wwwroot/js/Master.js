...
***************************************************************************************/
	...
	function CMasterTemplate(){
		this.cmi__core___children = new CAttributes("CMIString255","Read","true","","","","","student_id,student_name,lesson_location,credit,lesson_status,entry,score,total_time,exit,session_time");
...
***************************************************************************************/
		...
		function CFavorite(lIdentifier, lTitle){
...
***************************************************************************************/
	...
	/*
		gArrFunctionsState = new BVDictionary();
		gArrFunctionsState.Add("NotInitialized", "LMSInitialize LMSGetLastError LMSGetErrorString LMSGetDiagnostic");
		gArrFunctionsState.Add("Initialized", "LMSGetValue LMSSetValue LMSGetLastError LMSGetErrorString LMSGetDiagnostic LMSCommit LMSFinish");
		gArrFunctionsState.Add("Finished", "LMSGetLastError LMSGetErrorString LMSGetDiagnostic");
		gArrFunctionsState.Add("LMSFinishReturn", "true");
	*/
...
***************************************************************************************/
	...
	/*
		function CScormLookup(){
			this.Credit__credit = "credit";
			this.Credit__no-credit = "no-credit";
			this.Credit__Default = "credit";

			this.Result__correct = "correct";
			this.Result__wrong = "wrong";
			this.Result__unanticipated = "unanticipated";
			this.Result__neutral = "neutral";
			this.Result__CheckFor = "CMIDecimal";
		}
		var gScormLookups = new CScormLookup();
	*/
